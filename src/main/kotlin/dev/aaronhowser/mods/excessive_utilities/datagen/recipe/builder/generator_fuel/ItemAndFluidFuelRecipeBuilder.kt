...
class ItemAndFluidFuelRecipeBuilder(
	val generatorType: ItemAndFluidFuelRecipe.GeneratorType,
	...
	override fun save(recipeOutput: RecipeOutput, id: ResourceLocation) {
		...
		val recipe = ItemAndFluidFuelRecipe(generatorType, itemIngredient, fluidIngredient, fePerTick, duration)
		recipeOutput.accept(
			realId,
			recipe,
